...
CREATE TABLE llx_ecommerce_site (
  ...
  wordpress_authentication_type varchar(255) NULL,
  wordpress_authentication_login varchar(255) NULL,
  wordpress_authentication_password varchar(255) NULL,
  wordpress_timeout integer NOT NULL DEFAULT 30,
  wordpress_debug integer(1) NULL,
